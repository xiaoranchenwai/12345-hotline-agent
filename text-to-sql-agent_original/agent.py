...
#from langchain_openai.chat import ChatOpenAI
...
def create_sql_deep_agent():
    ...
    #model = ChatAnthropic(model_name="qwen3-235b",temperature=0,base_url="http://10.250.2.28:8081",api_key="none",timeout=30)
    model=init_chat_model(model="qwen",model_provider='openai',temperature=0,base_url="http://10.4.3.18:8000/v1",api_key="none",timeout=30)
...
Examples:
  ...
  python agent.py "How many customers are from Canada?"
    ...
    parser.add_argument(
        "--question",
        type=str,
        default="How many customers are from Canada?",
